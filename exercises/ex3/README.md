...
3. Once project opens, make sure you are on **Editable** version and then choose **Release**.

    <img src="./images/SBPA_Release00.png" width="90%" height="80%" />
    <!-- ![plot](./images/automatedprocess.png) -->

    On the pop up choose **Release** again.

    <<img src="./images/SBPA_Release01.png" width="90%" height="80%" />
